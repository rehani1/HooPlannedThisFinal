...
function AdvisorManager() {
      ...
      .insert([
        {
          ...
          advisor_role: form.advisor_role, // array
  ...
  const saveEdit = async () => {
    ...
    const { error } = await supabase
      ...
      .update({
        ...
        advisor_role: editForm.advisor_role, // array
  ...
  // helper to render checkbox group (reuse for create + edit)
...
//
//         <div style={{ display: "flex", flexDirection: "column", gap: 4}}>
//             <label style={{ fontWeight: 600 }}> Advisor Role (select all that apply):</label>
//             {[
//                 "First Year Council Advisor",
//                 "Second Year Council Advisor",
//                 "Third Year Councul Advisor",
//                 "Fourth Year Trustees Advisor",
//                 ].map((role) => (
//                     <label key{role} style={{ fontSize: 14}}>
//                         <input
//                             type="checkbox"
//                             checked={(form.advisor_role || []).includes(role)}
//                             onChange={(e) =>{
//                                 const  checked = e.target.checked;
//                                 let updated = form.advisor_role ? [...form.advisor_role] : [];
//                                 if (checked) {
//                                     updated.push(role);
//                                 } else{
//                                     updated = updated.filter((r) => r !== role);
//
//                                 }
//                                 setForm({... form, advisor_role: updated});
//                             }}
//                             />{" "}
//                         {role}
//                     </label>
